...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Open side panel only in response to a user gesture
  let sidePanelOpened = false;
  //function requestOpenSidePanel() {
  //  if (sidePanelOpened) return;
  //  openSidePanelForActiveTab().finally(() => { sidePanelOpened = true; });
  //}
  // First click anywhere in the popup counts as a user gesture
